    ...
    $puedeEvaluar = in_array($rolFormulario, ['PROPIETARIO', 'ADMIN', 'ADMINISTRADOR'], true);
    ...
    $criteriosServicio = [
        ...
        'eval_tiempo' => ['⏱️', 'Horas de Servicio'],
        'eval_ganancias' => ['💰', 'Ganancias']
    ];

    $criteriosDesempeno = [
        'eval_cuidado_vehiculo' => ['🚛', 'Cuidado del Camión'],
        'eval_productividad' => ['📋', 'Productividad (Días Trabajados)'],
        'eval_rendimiento' => ['⛽', 'Rendimiento de Combustible'],
        'eval_cuidado_fisico' => ['🛡️', 'Antidoping / Cuidado Físico']
    ];
        ...
        foreach ($criterios as $campo => [$icono, $nombre]) {
            ...
            <div class="eval-criterio">
                <div class="eval-nombre">
                    <span class="eval-icono"><?= $icono ?></span>
                ...
                <div class="eval-botones">
                    <?php for ($i = 1; $i <= $max; $i++): ?>
                        <button type="button"
                                ...
                                data-campo="<?= $campo ?>"
                                data-value="<?= $i ?>"
                                onclick="seleccionarEvaluacion('<?= $campo ?>', <?= $i ?>, this)">
                            <?= $i ?>
                        </button>
                    <?php endfor; ?>
                </div>
        ...
        <div class="modal-container">
            ...
            <div class="modal-header">
                ...
                <button type="button" class="btn-cerrar-modal"
                        onclick="cerrarModalReporte()">&times;</button>
            </div>
            ...
            <div class="modal-body-scroll">
                ...
                <form id="frm" class="form-grid"
                    ...
                    <div style="padding:12px 15px;margin-bottom:18px;border:1px solid var(--borde-sutil);border-radius:10px;color:var(--texto-secundario);">
                        Esta solicitud quedará pendiente hasta que el propietario o administrador
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="id_operador" id="id_operador" required>
                                ...
                                <?php foreach ($operadores ?? [] as $op):
                                    $id = (int)$op['id_operador'];

                                    if ((int)($op['estatus'] ?? 1) !== 1 ||
                    ...
                    <div style="margin-top:10px;padding:12px 15px;border-radius:10px;background:rgba(234,88,12,.08);border:1px solid rgba(234,88,12,.30);">
                        ...
                        <div style="margin-top:4px;font-size:.9rem;opacity:.8">
                            La evaluación será realizada por el propietario o administrador
    ...
    <div id="modalRevisionBaja" class="modal-overlay">
        <div class="modal-container">
            ...
            <div class="modal-header">
                <h2 class="modal-title-text">⭐ Evaluación del Operador</h2>

                <button type="button"
                        class="btn-cerrar-modal"
                        onclick="cerrarRevisionBaja()">&times;</button>
            </div>
            ...
            <div class="modal-body-scroll">
                ...
                <form id="frmRevisionBaja"
                    ...
                    <input type="hidden" id="revision_id_reporte" name="id_reporte">
                    ...
                    <div class="eval-seccion">
                        ...
                        <div class="eval-promedio">
                            ...
                            <span id="promedioServicioVista">— / 5</span>
                        </div>
                    ...
                    <div class="eval-resumen">
                        ...
                        <div class="eval-puntuacion" id="puntuacionGeneral">
                            — / 10
                        </div>

                        <div class="eval-clasificacion" id="clasificacionGeneral">
                    ...
                    <div style="margin-top:20px;padding:14px 16px;border-radius:10px;background:rgba(220,38,38,.08);border:1px solid rgba(220,38,38,.30);">
                        ...
                        <div style="margin-top:5px;font-size:.9rem;opacity:.85">
                            Al confirmar, el operador será marcado como inactivo y
                            todas las calificaciones quedarán guardadas permanentemente.
                        </div>
