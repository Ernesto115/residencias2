...
<?php foreach ($datos2 as $dato):
    ...
    if ((int)($dato['estatus'] ?? 1) !== 1) continue;
    ...
    <div class="modal-card"
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:15px;font-size:.9rem;text-align:left;">
            ...
            <div>
                ...
                <p>
                    <?= $h($dato['licencia_federal_actual'] ?: 'N/A') ?>
                </p>

                <?php if (!empty($dato['vencimiento_lic_federal'])): ?>
                    <p class="fecha-vencimiento">
                        Vence: <?= $h($dato['vencimiento_lic_federal']) ?>
                    </p>
                <?php endif; ?>
            ...
            <div>
                ...
                <p>
                    <?= $h($dato['apto_medico_actual'] ?: 'N/A') ?>
                </p>

                <?php if (!empty($dato['vencimiento_apto_medico'])): ?>
                    <p class="fecha-vencimiento">
                        Vence: <?= $h($dato['vencimiento_apto_medico']) ?>
                    </p>
                <?php endif; ?>
            ...
            <div>
                ...
                <div style="margin-top:10px;padding-bottom:14px;border-bottom:1px solid var(--borde-sutil);">
                    ...
                    <?php if (!empty($dato['vencimiento_visa'])): ?>
                        ...
                        <div style="padding:9px 11px;border-radius:8px;background:rgba(245,158,11,.10);border:1px solid rgba(245,158,11,.35);display:inline-block;">
                    ...
                    <?php if (!empty($dato['archivo_pdf_visa'])): ?>
                        ...
                        <div style="margin-top:10px;">
                            <a href="../uploads/pdf/<?= $h($dato['archivo_pdf_visa']) ?>"
                               target="_blank"
                               class="btn-pdf-link">
                                👁️ Ver VISA
                            </a>
                ...
                <div style="margin-top:14px;">
                    ...
                    <?php if (!empty($dato['fast_pdf'])): ?>
                        ...
                        <div style="margin-top:10px;">
                            <a href="../uploads/pdf/<?= $h($dato['fast_pdf']) ?>"
                               target="_blank"
                               class="btn-pdf-link">
                                👁️ Ver FAST
                            </a>
