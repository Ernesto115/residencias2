...
if ($id_operador > 0) {
    ...
    /* =====================================================
       NO CAMBIAR EMPRESA DE UN OPERADOR ACTIVO
       ===================================================== */

    if ($id_empresa !== $empresa_actual) {

        errorOperador(
            'No puedes cambiar de empresa a un operador activo. Primero debe completar su baja en la empresa actual y después podrá ser recontratado por otra empresa.',
            $db,
            true
        );
    }
